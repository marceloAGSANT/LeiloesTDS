...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void preencherTabela(String filtro) {
        ...
        if (!status) {
            ...
            List<ProdutosDTO> listaPodcasts = dao.listar(filtro);
            ...
            for (ProdutosDTO produtos : listaPodcasts) {
    ...
    vendas.setVisible(true);        //vendasVIEW vendas = new vendasVIEW();   //vendas.setVisible(true);
